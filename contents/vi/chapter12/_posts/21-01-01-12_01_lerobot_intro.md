...
## Đọc robot learning đúng mức

Dataset, embodiment, an toàn quan trọng không kém tên model.

<!--exp-->
## Gợi ý luyện

Giải thích “Giới thiệu LeRobot / HF robotics” trong 3 phút và liệt kê phần cứng cần có trên bàn để minh họa.
