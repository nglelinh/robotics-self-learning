---
layout: post
title: "Breadboards, multimeters, and probing"
chapter: "01"
order: 2
...
![Breadboard anatomy]({{ site.imgurl }}/generated/breadboard_anatomy.png)

![Multimeter]({{ site.imgurl }}/wikimedia/Digital_Multimeter_Aka.jpg)

![Breadboard photo]({{ site.imgurl }}/wikimedia/breadboard.jpg)
...
Teach-back: explain “Breadboards, multimeters, and probing” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
