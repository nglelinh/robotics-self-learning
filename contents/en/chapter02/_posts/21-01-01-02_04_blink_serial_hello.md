---
layout: post
title: "Lab: first blink, serial, and hello robot"
chapter: "02"
order: 4
...
Lab: blink + serial heartbeat. Motor-induced resets ⇒ brownout hunt.
...
Teach-back: explain “Lab: first blink, serial, and hello robot” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
