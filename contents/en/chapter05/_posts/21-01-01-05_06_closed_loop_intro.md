...
Lab: if range < threshold → PWM 0. Sense→compute→act.
...
Teach-back: explain “Lab: closed-loop intro sense → compute → act” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
