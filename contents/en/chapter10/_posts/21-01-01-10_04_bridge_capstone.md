...
Start with PC serial bridge cmd_vel→PWM; then micro-ROS.
...
## Sim/micro-ROS habits

Match SI units and frame names between sim and real. Prove cmd_vel→PWM on a serial bridge before optimizing DDS on-MCU.
...
Teach-back: explain “Bridging Capstone A firmware to ROS 2” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
