...
Capture→detect→act; lighting first; OpenCV.
...
Teach-back: explain “Basic vision pipeline for robots” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
