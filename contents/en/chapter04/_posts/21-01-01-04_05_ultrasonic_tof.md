...
![Ranging modules]({{ site.imgurl }}/generated/sensor_package_id.png)

## Core ideas

Lab: compare sensor distance to ruler; note FOV/soft target errors.
...
Teach-back: explain “Lab: ultrasonic and Time-of-Flight ranging” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
