...
![Chassis]({{ site.imgurl }}/generated/diff_drive_kinematics.png)

## Core ideas

Square chassis; mount motors; fused/switched battery plan; common GND.
...
Teach-back: explain “Assemble chassis, motors, and power” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
