...
Parse; timeout stop; clamp; optional ramp—still no ROS.
...
Teach-back: explain “Firmware teleop loop (no ROS yet)” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
