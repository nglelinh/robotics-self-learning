...
Framed packets e.g. `V L R\n`; document units −100..100.
...
Teach-back: explain “Teleop over serial: protocol design” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
