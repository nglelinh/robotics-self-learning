...
1 m corridor; pivots; unplug-host e-stop; file a bug.
...
Teach-back: explain “Field test, debug log, and acceptance” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
