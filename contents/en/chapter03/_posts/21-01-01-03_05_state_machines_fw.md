...
IDLE → TELEOP → FAULT beats spaghetti loop().
...
Teach-back: explain “State machines for robot firmware” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
