...
Lab: ESP32 MQTT pub/sub velocity-style topic on local broker.
...
Teach-back: explain “Lab: Wi-Fi and MQTT on ESP32” to a friend in 3 minutes, then list what hardware you’d put on the desk to demonstrate it.
